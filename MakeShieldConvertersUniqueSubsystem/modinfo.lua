...
meta =
{
    ...
    name = "MakeShieldConvertersUniqueSubsystem",

    -- Title of your mod that will be displayed to players
    title = "Balancing: Make Energy-to-Shield Converter modules unique modules.",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Makes Energy-to-Shield Converter modules a unique module, preventing their excessive abuse.",

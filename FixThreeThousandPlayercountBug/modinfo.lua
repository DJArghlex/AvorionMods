...
meta =
{
    ...
    name = "FixThreeThousandPlayercountBug",

    -- Title of your mod that will be displayed to players
    title = "Fix: 3000+ playerID'd players no longer spawn in the same sector.",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Fixes player spawn loop not working past 3000 or so players.",

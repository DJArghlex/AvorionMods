...
meta =
{
    ...
    id = "AncientGatesOpenByInventoryKey",
    ...
    name = "AncientGatesOpenByInventoryKey",

    -- Title of your mod that will be displayed to players
    title = "Ancient Gates: Open from Keys in Player Inventory",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Keeps ancient gates open if a player has the key in their inventory instead of on a ship in the sector.",
    ...
    contact = "comments section of Steam Workshop page",
}

...
meta =
{
    ...
    name = "InvincibleNPCStations",

    -- Title of your mod that will be displayed to players
    title = "Invincible NPC Stations",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Makes NPC stations (except for those owned by Pirate factions) invincible, as well as resets their crew. Will also grant immunity to EMP and Ionized Projectile damage. Usable as a server-side only mod.",

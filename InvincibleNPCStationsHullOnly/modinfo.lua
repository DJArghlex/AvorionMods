...
meta =
{
    ...
    name = "InvincibleNPCStationsHullOnly",

    -- Title of your mod that will be displayed to players
    title = "Invincible NPC Stations (Hull Only)",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Makes NPC stations (except for those owned by Pirate factions) invincible, but only their hull.",

...
meta =
{
    ...
    name = "EnergySignatureSuppressorImprovement",

    -- Title of your mod that will be displayed to players
    title = "Energy Signature Suppressor Improvements",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Retunes the Energy Signature Suppressor in a variety of ways.",

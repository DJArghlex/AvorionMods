...
meta =
{
    ...
    name = "ServerLib-ForceFactionsToRebuild",

    -- Title of your mod that will be displayed to players
    title = "Server Library: Force NPC Factions to Rebuild Stations",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Force NPC factions to rebuild their stations more frequently. Theoretically, every ten minutes a faction will attempt to reconstruct one of their stations.",

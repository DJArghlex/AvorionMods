...
meta =
{
    ...
    name = "KSP_Marker_Vanilla_VersionBump",

    -- Title of your mod that will be displayed to players
    title = "KSP Prograde/Retrograde Markers Redux (Vanilla Colours) [2.0+]",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Enlarges and changes shape of prograde/retrograde markers to resemble those from KSP. The markers are the same colour as vanilla Avorion (Cyan Prograde, Purple Retrograde) ",

    -- Insert all authors into this list
    authors = {"LivewareCascade", "rglx (version bump & mod metadata changes)"},

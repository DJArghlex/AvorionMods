...
meta =
{
    ...
    name = "ServerLib-OfflineBehemothNeutralizer",

    -- Title of your mod that will be displayed to players
    title = "Server Library: Offline Behemoths Neutralizer",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Prevents the Behemoths gameplay from deleting your NPC sectors if nobody is online to defend.",

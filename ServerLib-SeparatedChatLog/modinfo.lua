...
meta =
{
    ...
    name = "ServerLib-SeparatedChatLog",

    -- Title of your mod that will be displayed to players
    title = "ServerLib-SeparatedChatLog",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Server mod to copy most of the chatlog out of the game's main log-file, which seems not to regularly write out to file",

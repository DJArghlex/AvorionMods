...
meta =
{
    ...
    name = "ServerLib-WarzoneNerfer",

    -- Title of your mod that will be displayed to players
    title = "Server Library: Warzone Nerfer",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Mod to remove temporary defenders from a sector when no players are present. This should prevent hundreds of ships building up in the sector.",

    -- Insert all authors into this list
    authors = {"void catgirl rglx"},

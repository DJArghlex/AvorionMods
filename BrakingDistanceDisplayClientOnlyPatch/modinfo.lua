...
meta =
{
    ...
    id = "BrakingDistanceDisplayClientOnlyPatch",
    ...
    name = "BrakingDistanceDisplayClientOnlyPatch",

    -- Title of your mod that will be displayed to players
    title = "Braking Distance Display: Client-only Patch",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "patches the Braking Distance Display mod to work without the server loading it for you.",

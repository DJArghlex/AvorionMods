...
meta =
{
    ...
    name = "MakeTractorBeamsUniqueSubsystem",

    -- Title of your mod that will be displayed to players
    title = "Balancing: Make Tractor Beam modules unique modules.",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Makes Tractor Beam modules a unique module, preventing their excessive abuse.",

...
meta =
{
    ...
    name = "MissingObjFilesPatch",

    -- Title of your mod that will be displayed to players
    title = "Missing Goods Models Patch",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Patch mod for a bug introduced in v2.0.9 wherein the developers forgot to actually *include* their new models for cargo and goods, causing the in-game console to be filled with a bunch of error messages. This just adds a simple cube in their place to shut TinyObjReader up.",

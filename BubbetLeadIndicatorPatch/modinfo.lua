...
meta =
{
    ...
    name = "BubbetLeadIndicatorPatch",

    -- Title of your mod that will be displayed to players
    title = "Lead Indicator: Patched!",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "patch-mod/drop-in replacement for Bubbet's Lead Indicator mod to remove dependency on outdated UIElements mod.",

    -- Insert all authors into this list
    authors = {"rglx", "original code by Bubbet!"},
    ...
    -- },
    dependencies = {
        {id = "2330420252", exact = "*.*", incompatible = true},
        {id = "Avorion", exact = "*.*"}
    },

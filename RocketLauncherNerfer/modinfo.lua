...
meta =
{
    ...
    name = "RocketLauncherNerfer",

    -- Title of your mod that will be displayed to players
    title = "Rocket Launcher Nerfer",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Heavily nerfs the fire-rate of rocket launchers to discourage their use as a primary weapon that creates hundreds of persistent guided entities that hang sectors.",
